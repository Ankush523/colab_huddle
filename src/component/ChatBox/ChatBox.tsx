...
function ChatBox() {
  ...
  return (
    <div className="w-full border-2 border-white rounded-lg flex flex-col">
      <h1 className="text-center text-2xl my-2 border-b border-white">
        Chat Room
      </h1>
      <div className="flex-1 p-4 border-b border-white overflow-auto">
